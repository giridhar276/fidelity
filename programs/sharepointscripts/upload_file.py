...
with open("example.txt", "rb") as content_file:
    file_content = content_file.read()

upload_file = folder.upload_file("example.txt", file_content).execute_query()
print("Uploaded file URL:", upload_file.serverRelativeUrl)
